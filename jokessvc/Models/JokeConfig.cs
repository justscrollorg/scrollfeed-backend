...
{
    public string MongoUri { get; set; } = "mongodb://novell:novell123@mongodb.mongo.svc.cluster.local:27017/jokedb?authSource=admin";
    public string DatabaseName { get; set; } = "jokedb";
    public string CollectionName { get; set; } = "jokes";
    public string NatsUrl { get; set; } = "nats://nats.nats-system.svc.cluster.local:4222";
